...
---race here------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        MenuCreation = {
            ...
            element3 = {
                label = "Choose A race",
                desc = "Select your character's race"
            },
            element4 = { 
                label = "Choose Name", 
                desc = "Choose a name for your character make sure you read the rules for character naming,<br> if you fail to follow the rules this character will be deleted with no warning" 
            }, 
            element5 = { label = "Start Journey", desc = "Start your journey by pressing enter" }
        },
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------        
        MenuClothes = {
            title       = "Clothing",
        ...
        Menurace = {
            title = "Select Race",
            subtitle = "Choose your character's race",
            items = {
                { race = "Vampire", label = "Vampire", description = "Play as a vampire" },
                { race = "Werewolf", label = "Werewolf", description = "Become a werewolf" },
                { race = "Human", label = "Human", description = "Remain human" },
            },
        },
        MenuClothes = {
            title       = "Abbigliamento",
